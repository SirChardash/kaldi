...
# run_cnn_tdnn_1d.sh is modified from run_cnn_tdnn_1a.sh, but with attention, multiple stream, specturm augmentation, without dropout

# ./local/chain/compare_wer.sh --online exp/chain/cnn_tdnn1c_sp exp/chain/cnn_tdnn1d_sp
# System                cnn_tdnn1c_sp cnn_tdnn1d_sp
#WER dev_clean_2 (tgsmall)       9.81      9.63
#             [online:]          9.83      9.63
#WER dev_clean_2 (tglarge)       6.84      6.79
#             [online:]          6.87      6.78
# Final train prob        -0.0543   -0.0545
# Final valid prob        -0.0739   -0.0748
# Final train prob (xent)   -1.2976   -1.3155
# Final valid prob (xent)   -1.4212   -1.4366
# Num-params                11067218  11736812
...
if [ $stage -le 13 ]; then
  ...
  tdnnf-layer name=tdnnf16 input=cnn6 $tdnnf_first_opts dim=768 bottleneck-dim=192 time-stride=0
  tdnnf-layer name=tdnnf17 input=tdnnf16 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf18 input=tdnnf17 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf19 input=tdnnf18 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf20 input=tdnnf19 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf21 input=tdnnf20 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf22 input=tdnnf21 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf23 input=tdnnf22 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf24 input=tdnnf23 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  attention-relu-batchnorm-layer input=tdnnf24 name=attention1 time-stride=2 num-heads=12 value-dim=60 key-dim=40 num-left-inputs=4 num-right-inputs=4

  tdnnf-layer name=tdnnf25 input=cnn6 $tdnnf_first_opts dim=768 bottleneck-dim=192 time-stride=0
  tdnnf-layer name=tdnnf26 input=tdnnf25 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=1
  tdnnf-layer name=tdnnf27 input=tdnnf26 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf28 input=tdnnf27 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf29 input=tdnnf28 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf30 input=tdnnf29 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=2
  tdnnf-layer name=tdnnf31 input=tdnnf30 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=3
  tdnnf-layer name=tdnnf32 input=tdnnf31 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=3
  tdnnf-layer name=tdnnf33 input=tdnnf32 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=3
  tdnnf-layer name=tdnnf34 input=tdnnf33 $tdnnf_opts dim=768 bottleneck-dim=96 time-stride=3
